...
pub struct Osm {
    ...
    hilbert_node_pairs : Option<&'static [super::osm::HilbertRelationPair]>,
    ways : &'static [super::osm::Way],
    hilbert_way_pairs : Option<&'static [super::osm::HilbertRelationPair]>,
...
/// A node references a range of tags in the `tags_index` vector.
    ...
    #[inline]
    pub fn hilbert_node_pairs(&self) -> Option<&[super::osm::HilbertRelationPair]> {
...
/// * a range of nodes in the `nodes_index` vector.
    ...
    #[inline]
    pub fn hilbert_way_pairs(&self) -> Option<&[super::osm::HilbertRelationPair]> {
...
impl Osm {
        ...
        -> ::std::result::Result<Self, flatdata::ResourceStorageError>
    {
        ...
        let hilbert_node_pairs = {
            ...
            check("hilbert_node_pairs", |r| r.len(), max_size, resource.and_then(|x| <&[super::osm::HilbertRelationPair]>::from_bytes(x)))?
        };
        let ways = {
            use flatdata::check_resource as check;
            let max_size = Some(1099511627776);
        ...
        let hilbert_way_pairs = {
            ...
            check("hilbert_way_pairs", |r| r.len(), max_size, resource.and_then(|x| <&[super::osm::HilbertRelationPair]>::from_bytes(x)))?
        };
        let relations = {
            use flatdata::check_resource as check;
            let max_size = Some(1099511627776);
...
impl OsmBuilder {
    ...
    pub fn set_hilbert_node_pairs(&self, vector: &[super::osm::HilbertRelationPair]) -> ::std::io::Result<()> {
        use flatdata::SliceExt;
    ...
    /// [`ExternalVector::close`]: flatdata/struct.ExternalVector.html#method.close
    #[inline]
    pub fn start_hilbert_node_pairs(&self) -> ::std::io::Result<flatdata::ExternalVector<super::osm::HilbertRelationPair>> {
    ...
    pub fn set_hilbert_way_pairs(&self, vector: &[super::osm::HilbertRelationPair]) -> ::std::io::Result<()> {
        use flatdata::SliceExt;
    ...
    /// [`ExternalVector::close`]: flatdata/struct.ExternalVector.html#method.close
    #[inline]
    pub fn start_hilbert_way_pairs(&self) -> ::std::io::Result<flatdata::ExternalVector<super::osm::HilbertRelationPair>> {
